...
function (
    ...
    dt.dataTable({
        "oLanguage": {sProcessing: "<img src='../assets/manu077/img/loading2.gif'>"},
        "processing": true,
        "dom": "lfBrtip",
        "serverSide": true,
        ...
        "buttons": [
            {
                ...
                customize: function ( win ) {
                    $(win.document.body)
                        ...
                        .prepend(
                            '<div class="dt-print-heading"><img class="logo" src='+baseUrl+'"/assets/manu077/img/logo-favicons/1_logo.png"/><h2 class="title">'+window.store.name+'</h2><p><b><i>From</i> '+window.from +' <i>To</i> '+window.to+'</b><br>Printed on: '+window.formatDate(new Date())+'</p></div>'
    ...
    $(document).delegate("#reset", "click", function (e) {
        ...
        $("#to_store_id").val("").trigger("change");
        $("#image_thumb img").attr("src", "../assets/manu077/img/noimage.jpg");
        $("#image").val("");
