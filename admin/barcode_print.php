...
// Add Style
$document->addStyle('../assets/manu077/css/barcode.css', 'stylesheet', 'all');

// Add Script
$document->addScript('../assets/manu077/angular/controllers/BarcodePrintController.js');
                        ...
                        <div class="item-inner">
                          <?php if (isset($request->post['fields']['product_image']) && $request->post['fields']['product_image']):?>
                            <span class="product_image">
                              ...
                              <?php else : ?>
                                <img src="../assets/manu077/img/noimage.jpg">
                              <?php endif; ?>
                            </span>
                          <?php endif;?>
                          <?php if (isset($request->post['fields']['site_name']) && $request->post['fields']['site_name']):?>
