...
// Add ScriptS
$document->addScript('../assets/manu077/angular/modals/InstallmentPaymentModal.js');
$document->addScript('../assets/manu077/angular/modals/InstallmentViewModal.js');
$document->addScript('../assets/manu077/angular/modals/CustomerSubstractBalanceModal.js');
$document->addScript('../assets/manu077/angular/modals/CustomerAddBalanceModal.js');
$document->addScript('../assets/manu077/angular/controllers/CustomerController.js');
$document->addScript('../assets/manu077/angular/controllers/CustomerProfileController.js');
