...
// Add Script
$document->addScript('../assets/manu077/angular/controllers/StoreActionController.js');
$document->addScript('../assets/manu077/js/upload.js');
					...
					<div class="form-group">
						...
						<div class="col-sm-2 text-center">	            
							<div id="logo_preview">
								...
								<?php else: ?>
									<img id="logo" src="../assets/manu077/img/logo-favicons/nologo.png">
								<?php endif; ?>
							</div>
							<p>
								Max. 100 kb
						...
						<?php if (user_group_id() == 1 || has_permission('access', 'upload_logo')) : ?>
						    <div class="col-sm-4">	            
								<div class="upload-field" id="selectImage">
									...
									<img class="loader logo-loader" src="../assets/manu077/img/loading.gif">
								</div>
						    </div>
						<?php endif; ?>
					...
					<div class="form-group">
						...
						<div class="col-sm-2 text-center">	            
							<div id="favicon_preview">
								...
								<?php else: ?>
									<img id="favicon" src="../assets/manu077/img/logo-favicons/nofavicon.png">
								<?php endif; ?>
							</div>
							<p>
								Max. 50 kb
						...
						<?php if (user_group_id() == 1 || has_permission('access', 'upload_favicon')) : ?>
							<div class="col-sm-4">	            
								<div class="upload-field" id="selectFavicon">
									...
									<img class="loader favicon-loader" src="../assets/manu077/img/loading.gif">
								</div>
							</div>
						<?php endif; ?>
						<div class="clearfix"></div>
