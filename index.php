...
<head>
    ...
    <?php if (DEMO || USECOMPILEDASSET) : ?>
        ...
        <!-- LOGIN COMBINED CSS -->
        <link type="text/css" href="assets/manu077/cssmin/login.css" rel="stylesheet">
    ...
    <?php else : ?>
        ...
        <!-- Theme CSS -->
        <link type="text/css" href="assets/manu077/css/theme.css" rel="stylesheet">

        <!-- Login CSS -->
        <link type="text/css" href="assets/manu077/css/login.css" rel="stylesheet">
    ...
    <?php if (DEMO || USECOMPILEDASSET) : ?>
        ...
        <!-- Login Combined JS -->
        <script src="assets/manu077/jsmin/login.js"></script>
    ...
    <?php else : ?>
        ...
        <!-- Common JS -->
        <script src="assets/manu077/js/common.js"></script>

        <!-- Login JS -->
        <script src="assets/manu077/js/login.js"></script>

    <?php endif; ?>

</head>
<body class="login-page">
<div class="hidden"><?php include('assets/manu077/img/iconmin/membership/membership.svg'); ?></div>
        ...
        <form id="login-form" action="login.php" method="post">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" value="tusolutionweb@gmail.com"
                           placeholder="Email / Phone No." name="username">
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input type="password" class="form-control" value="tusolutionweb" placeholder="Password"
                           name="password">
                </div>
            </div>

            <button type="submit" id="login-btn" class="btn btn-success btn-block btn-flat"
            ...
            <div id="credentials">
                <table class="table table-bordered table-striped">
                    ...
                    <?php foreach (get_users() as $the_user) : ?>
                        <?php if (in_array($the_user['email'], array('admin@manu077.com', 'cashier@manu077.com', 'salesman@manu077.com'))) : ?>
                            <tr title="Login as Admin">
                                <td class="username"
                                    data-username="<?php echo $the_user['email']; ?>"><?php echo $the_user['email']; ?></td>
                                <td class="password text-center"
                                    data-password="<?php echo $the_user['raw_password']; ?>"><?php echo $the_user['raw_password']; ?></td>
                            </tr>
                        <?php endif; ?>
                    <?php endforeach; ?>
                    </tbody>
            ...
            <div>
                ...
                <p class="text-center">
                    <a href="#forgotPasswordModal" data-toggle="modal" data-target="#forgotPasswordModal"
                       title="<?php echo trans('text_forgot_password'); ?>" class="text-danger">
...
<?php if (!DEMO) : ?>
    ...
    <div id="forgotPasswordModal" class="modal fade" aria-hidden="false" aria-labelledby="forgotPasswordModal"
                ...
                <form action="#" method="post" accept-charset="utf-8">
                    ...
                    <div class="modal-footer">
                        <button data-dismiss="modal" class="btn btn-warning pull-left"
                                type="button"><?php echo trans('button_close'); ?></button>
                        <button id="reset-btn" name="reset-btn" class="btn btn-success" type="submit"
                                data-loading-text="Email Sending...">
