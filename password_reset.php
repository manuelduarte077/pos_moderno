...
<head>
  ...
  <?php else : ?>
    ...
    <!-- Forgot Password JS-->
    <script src="assets/manu077/js/forgot-password.js"></script>
...
<div class="hidden"><?php include('assets/manu077/img/iconmin/membership/membership.svg');?></div>
  ...
  <section class="login-box">
    ...
    <div class="copyright text-center">
      <p>&copy; <a href="https://github.com/manuelduarte077">manuelduarte077</a>, v<?php echo settings('version'); ?></p>
    </div>
  </section>
